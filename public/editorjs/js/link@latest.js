 ...
 * Original file: /npm/@editorjs/link@2.4.0/dist/bundle.js
 *
            ...
            y = (n(18), function () {
                function t(e) {
                    var n = e.data,
                        ...
                        o = e.api,
                        i = e.readOnly;
                    l()(this, t), this.api = o, this.readOnly = i, this.config = {
                        endpoint: r.endpoint || "",
                        headers: r.headers || {}
                    }, this.nodes = {
                        wrapper: null,
                ...
                return h()(t, null, [{
                    ...
                    value: function () {
                        ...
                        }), this.nodes.input.dataset.placeholder = this.api.i18n.t("Link"), this.readOnly || (this.nodes.input.addEventListener("paste", (function (e) {
                            t.startFetching(e)
                    ...
                    key: "fetchLinkData",
                    value: (e = c()(a.a.mark((function t(e) {
                        var n, r;
            ...
            for (var n = {}, r = [], o = 0; o < t.length; o++) {
                ...
                var f = s(l),
                    h = {
                        ...
                        media: i[2],
                        sourceMap: i[3]
                    }; - 1 !== f ? (a[f].references++, a[f].updater(h)) : a.push({
                    identifier: l,
                    updater: v(h, e),
                    references: 1
                }), r.push(l)
