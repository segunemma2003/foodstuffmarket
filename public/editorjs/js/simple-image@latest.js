    ...
    return function (t) {
        ...
        var o = function () {
            function t(e) {
                ...
                }(this, t), this.api = r, this.readOnly = i, this.blockIndex = this.api.blocks.getCurrentBlockIndex() + 1, this.CSS = {
            ...
            return e = t, o = [{
                ...
                value: function () {
                    ...
                    return o.dataset.placeholder = "Enter a caption", e.appendChild(n), this.data.url && (i.src = this.data.url), i.onload = function () {
                        e.classList.remove(t.CSS.loading), r.appendChild(i), e.appendChild(r), e.appendChild(o), n.remove(), t._acceptTuneView()
                ...
                value: function (t) {
                    ...
                    switch (t.type) {
                        ...
                        case "file":
                            var i = t.detail.file;
                            this.onDropHandler(i).then(function (t) {
                                e.data = t
                            })
                    }
                }
                ...
                value: function () {
                    ...
                    return this.settings.forEach(function (n) {
                        ...
                        r.classList.add(t.CSS.settingsButton), r.innerHTML = n.icon, r.addEventListener("click", function () {
                            t._toggleTune(n.name), r.classList.toggle(t.CSS.settingsButtonActive)
                        }), r.classList.toggle(t.CSS.settingsButtonActive, t.data[n.name]), e.appendChild(r)
                    }), e
                }
            }, {
                key: "_make",
                value: function (t) {
                    ...
                    Array.isArray(n) ? (e = o.classList).add.apply(e, r(n)) : n && o.classList.add(n);
