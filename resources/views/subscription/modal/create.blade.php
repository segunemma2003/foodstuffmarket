    ...
    <div class="modal__content modal__content--xl p-10">
        ...
        <div class="grid grid-cols-12 gap-12 mt-5">
            <div class="intro-y col-span-12 lg:col-span-12">
                ...
                <form class="" enctype="multipart/form-data" action="{{ route('subscription.store') }}"
                    method="POST">
                    @csrf
                    ...
                    <div class="mt-3">
                        <div class="input-form"> <label class="flex flex-col sm:flex-row"> @translate(Plan Name) <span
                            ...
                            <select data-placeholder="Select your favorite actors" name="name" data-search="true"
                                class="tail-select w-full" single required>
                    ...
                    <div class="mt-3">
                        <div class="input-form"> <label class="flex flex-col sm:flex-row"> @translate(Plan Description) <span
                                    class="sm:ml-auto mt-1 sm:mt-0 text-xs text-gray-600">Ex: This plan is all about
                                    free users</span>
                            </label>
                    ...
                    <div class="mt-3">
                        <div class="input-form"> <label class="flex flex-col sm:flex-row"> @translate(Plan Duration) <span
                            ...
                            <select data-placeholder="Select your favorite actors" name="duration" data-search="true"
                                class="tail-select w-full" single required>
                    ...
                    <div class="mt-3">
                        <div class="input-form"> <label class="flex flex-col sm:flex-row"> @translate(Limits  Of Email) <span
                            ...
                            </label> <input type="number" name="emails" class="input w-full border mt-2"
                                placeholder="Limits Of Email" required>
                        </div>
                    </div>
                    ...
                    <div class="mt-3">
                        <div class="input-form"> <label class="flex flex-col sm:flex-row"> @translate(Limits Of SMS) <span
                                    class="sm:ml-auto mt-1 sm:mt-0 text-xs text-gray-600">Ex: 1000</span>
                            </label> <input type="number" name="sms" class="input w-full border mt-2"
                                placeholder="Limits Of SMS" required>
                        </div>
                    </div>
                    ...
                    <div class="mt-3">
                        <div class="input-form"> <label class="flex flex-col sm:flex-row"> @translate(Plan Price) <span
                            ...
                            </label> <input type="number" name="price" class="input w-full border mt-2"
                    ...
                    {{-- agent limit --}}
                    <div class="mt-3">
                        <div class="input-form"> <label class="flex flex-col sm:flex-row"> @translate(Plan Agent Limit) <span
                                    class="sm:ml-auto mt-1 sm:mt-0 text-xs text-gray-600">Ex: 100</span>
                            </label> <input type="number" name="agent_limit" class="input w-full border mt-2"
                    ...
                    <div class="flex items-center text-gray-700 dark:text-gray-500 mt-5">
                        <input type="checkbox" name="status" value="1" class="input border mr-2" checked
                            id="vertical-remember-me">
                        <label class="cursor-pointer select-none" for="vertical-remember-me">Publish Now</label>
                    </div>

                    <div class="flex items-center text-gray-700 dark:text-gray-500 mt-5">
                        <input type="checkbox" name="display" value="1" class="input border mr-2" checked
                            id="vertical-remember-me">
                    ...
                    <button type="submit" class="button bg-theme-1 text-white mt-5">@translate(Publish)</button>
                </form>
                <!-- END: Form Layout -->
