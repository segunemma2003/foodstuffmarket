		...
		<div id="rev_slider_10_1_wrapper" class="rev_slider_wrapper fullwidthbanner-container" data-alias="email-marketing" style="margin:0px auto;background-color:transparent;padding:0px;margin-top:0px;margin-bottom:0px;">
			...
			<div id="rev_slider_10_1" class="rev_slider fullwidthabanner tp-overflow-hidden" style="display:none;" data-version="5.2.6">
				...
				<li data-index="rs-23" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300"  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
					<!-- MAIN IMAGE -->
					<img src="{{ filePath('frontend/revslider/assets/abe02-04.png') }}"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="off" class="rev-slidebg" data-no-retina>
					<!-- LAYERS -->
					<!-- LAYER NR. 1 -->
					...
					style="z-index: 9;">
					<img src="{{ filePath(frontend('slider_image') ?? null) }}" alt="" data-ww="auto" data-hh="auto" data-no-retina>
					...
					style="z-index: 10;">
					<img src="{{ filePath('frontend/revslider/assets/3d839-03.png') }}" alt="" data-ww="auto" data-hh="auto" data-no-retina>
        ...
        <!-- END REVOLUTION SLIDER -->
			...
			<div class="main-content">
				...
				<section class="iq-driver-sale pt-0 mt-5 position-relative">
					<div class="container">
						<div class="row flex-row-reverse">
							<div class="col-lg-6 align-self-center position-relative wow slideInRight">
								<img src="{{ filePath(frontendModule('module1')->image ?? null) }}" class="img-fluid" alt="images">
					...
					<img src="{{ filePath('frontend/images/bg/01.png') }}" class="img-fluid bg-one" alt="images">
				</section>
				<!-- Driver sales  End-->
				...
				<section class="iq-driver-sale pt-0 position-relative">
					<div class="container">
						<div class="row ">
							<div class="col-lg-6 align-self-center position-relative wow slideInLeft">
								<img src="{{ filePath(frontendModule('module2')->image ?? null) }}" class="img-fluid" alt="images">
					...
					<img src="{{ filePath('frontend/images/bg/02.png') }}" class="img-fluid bg-two" alt="images">
				</section>
				<!-- Driver sales  End-->
				<!-- Driver sales -->
						...
						<div class="row ">
							...
							<div class="col-lg-6 align-self-center position-relative iq-rmt-50 ">
								<div class="scrollme">
									...
									<img src="{{ filePath(frontendModule('module3')->image ?? null) }}"
									class="img-fluid"
									data-when="enter"
									data-from="1"
									data-to="0"
				...
				<section class="lightblue-bg">
					<div class="container">
						<div class="row ">
							<div class="col-lg-6 align-self-center position-relative wow slideInLeft">
								<img src="{{ filePath(frontendModule('module4')->image ?? null) }}" class="img-fluid" alt="images">
						...
						<div class="row">
							...
							<div class="col-lg-6 col-md-6">
								<div class="feature-box wow slideInUp" data-wow-duration="1s">
									<div class="iq-icon">
										<img src="{{ filePath(frontendFeatures('features1')->icon ?? null) }}" alt="images" class="img-fluid">
							...
							<div class="col-lg-6 col-md-6">
								<div class="feature-box wow slideInUp" data-wow-duration="1s">
									<div class="iq-icon">
										<img src="{{ filePath(frontendFeatures('features2')->icon ?? null) }}" alt="images" class="img-fluid">
							...
							<div class="col-lg-6 col-md-6">
								<div class="feature-box wow slideInUp" data-wow-duration="1s">
									<div class="iq-icon">
										<img src="{{ filePath(frontendFeatures('features3')->icon ?? null) }}" alt="images" class="img-fluid">
							...
							<div class="col-lg-6 col-md-6">
								<div class="feature-box wow slideInUp" data-wow-duration="1s">
									<div class="iq-icon">
										<img src="{{ filePath(frontendFeatures('features4')->icon ?? null) }}" alt="images" class="img-fluid">
							...
							<div class="col-lg-6 col-md-6">
								<div class="feature-box wow slideInUp" data-wow-duration="1s">
									<div class="iq-icon">
										<img src="{{ filePath(frontendFeatures('features5')->icon ?? null) }}" alt="images" class="img-fluid">
							...
							<div class="col-lg-6 col-md-6">
								<div class="feature-box wow slideInUp" data-wow-duration="1s">
									<div class="iq-icon">
										<img src="{{ filePath(frontendFeatures('features6')->icon ?? null) }}" alt="images" class="img-fluid">
				...
				<section class="pt-0" id="pricing">
					...
					<div class="row align-items-center {{ $loop->iteration % 2 == 0 ? 'flex-row-reverse' : null }}">
						<div class="col-lg-6">
							<img class="img-fluid" src="{{ filePath('frontend/images/pricing/602.png') }}" alt="img">
						</div>
						<div class="col-lg-6">
						...
						<div class="col-lg-12 text-center">
							...
							@if (!$loop->last)
								...
								@if ($loop->iteration % 2 == 0 ? 'flex-row-reverse' : null)
									<img class="img-fluid" src="{{ filePath('frontend/images/pricing/605.png') }}" alt="img">
								@else
									<img class="img-fluid" src="{{ filePath('frontend/images/pricing/603.png') }}" alt="img">
								@endif
