                ...
                <div class="p-5">
                    <div class="grid grid-cols-12 gap-5">
                        <div class="col-span-12 xl:col-span-12">
                            ...
                            <div class="mt-3">
                                <label for="default_currencies" class="flex flex-col sm:flex-row">@translate(Default Currency)</label>
                                <select name="default_currencies" id="default_currencies" class="w-full form-select sm:w-1/2">
                                    @foreach (\App\Models\Currency::all() as $currency)
                                        <option value="{{ $currency->id }}" {{ $currency->id == org('default_currencies') ? 'selected' : '' }}>
                            ...
                            <div class="mt-3">
                                <label for="site_timezone" class="flex flex-col sm:flex-row">@translate(Timezone)</label>
                                                                            ...
                                                                            <div class="">
                                                                                <div class="h-60 xxl:h-60 image-fit">
                                                                                    <div class="rounded-md preview-template">
                                                                                        <div 
                                                                                            style="background-image: url('{{ filePath('layouts/classic.png') }}');" 
                                                                        ...
                                                                        <label class="for-checkbox-tools w-full" for="tool-2">
                                                                            <div class="">
                                                                                <div class="h-60 xxl:h-60">
                                                                                    <div class="rounded-md preview-template">
                                                                                        <div 
                                                                                            style="background-image: url('{{ filePath('layouts/modern.png') }}');" 
                                                                                            class="preview-template">
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                        ...
                                                                        <label class="for-checkbox-tools w-full" for="tool-3">
                                                                            <div class="">
                                                                                <div class="h-60 xxl:h-60 image-fit">
                                                                                    <div class="rounded-md preview-template">
                                                                                        <div 
                                                                                            style="background-image: url('{{ filePath('layouts/ltr.png') }}');" 
                                                                                            class="preview-template">
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                        ...
                                                                        <label class="for-checkbox-tools w-full" for="tool-4">
                                                                            <div class="">
                                                                                <div class="h-60 xxl:h-60">
                                                                                    <div class="rounded-md preview-template">
                                                                                        <div 
                                                                                            style="background-image: url('{{ filePath('layouts/rtl.png') }}');" 
                                                                                            class="preview-template">
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                    ...
                                                                    <label class="for-checkbox-tools w-full" for="neon">
                                                                        <div class="">
                                                                            <div class="h-60 xxl:h-60 image-fit">
                                                                                <div class="rounded-md preview-template">
                                                                                    <div 
                                                                                        style="background-image: url('{{ filePath('themes/neon.png') }}');" 
                                                                                        class="preview-template">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                    ...
                                                                    <label class="for-checkbox-tools w-full" for="argon">
                                                                        <div class="">
                                                                            <div class="h-60 xxl:h-60 image-fit">
                                                                                <div class="rounded-md preview-template">
                                                                                    <div 
                                                                                        style="background-image: url('{{ filePath('themes/argon.png') }}');" 
                                                                                        class="preview-template">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                            ...
                            <div class="mt-3">
                                <label>@translate(Disable Contact Form)</label>
                                <input type="checkbox" name="disable_contact_form" class="input w-full border mt-2" value="1" {{ env('DISABLE_CONTACT_FORM') == 'YES' ? 'checked' : '' }}>
                            </div>
