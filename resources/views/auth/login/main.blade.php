        ...
        <div class="xl:grid grid-cols-2 gap-4">
            ...
            <div class="flex-col min-h-screen hidden sm:hidden md:flex lg:flex xl:flex">
                ...
                <div class="my-auto">
                    ...
                    <div class="-intro-x text-white font-medium text-4xl leading-tight mt-10">@translate(A few more clicks to) <br>
                        @translate(sign in to your account.)</div>
                </div>
            </div>
            <!-- END: Login Info -->
            <!-- BEGIN: Login Form -->
                ...
                <div
                    ...
                    <form action="{{ route('login') }}" method="post">
                        ...
                        <div class="intro-x mt-5 xl:mt-8 text-center xl:text-left">
                            <button id="btn-login"
                                class="button button--lg w-full xl:w-32 text-white bg-theme-1 xl:mr-3 align-top">@translate(Login)</button>
                            <button type="button" onclick="location.replace('/register')"
                                ...
                                id="btn-signup">@translate(Sign up)</button>
                        </div>
                    </form>
