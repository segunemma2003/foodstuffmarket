    ...
    <div class="container">
        ...
        <div class="error-page flex flex-col lg:flex-row items-center justify-center h-screen text-center lg:text-left">
            <div class="-intro-x lg:mr-20">
                <img alt="Maildoll" class="" src="{{ filePath('invoice/success.gif') }}">
            </div>
            <div class="text-white mt-10 lg:mt-0">
                ...
                <a href="{{ route('dashboard') }}"
                    class="intro-x button button--lg border border-white dark:border-dark-5 dark:text-gray-300 mt-10">@translate(Back to Home)</a>
            </div>
        </div>
        <!-- END: Error Page -->
    </div>
