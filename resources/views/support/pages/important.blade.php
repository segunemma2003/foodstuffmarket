                                    ...
                                    <div class="inline-block min-w-full shadow rounded-lg overflow-hidden">
                                        ...
                                        @if (Auth::user()->user_type == 'Admin')
                                            <div class="intro-y col-span-12 text-center">
                                                <div class="md:block mx-auto text-gray-600">Showing
                                                    {{ supportTicketList()->firstItem() ?? '0' }} to
                                                    {{ supportTicketList()->lastItem() ?? '0' }} of
                                                    {{ supportTicketList()->total() }} entries
                                                </div>
                                            </div>
                                            <!-- END: Data List -->
                                            <!-- BEGIN: Pagination -->
                                            {{ supportTicketList()->links('vendor.pagination.custom') }}
                                            <!-- END: Pagination -->
                                        @endif
