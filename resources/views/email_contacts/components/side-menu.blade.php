<div class="col-span-12 lg:col-span-3 xxl:col-span-2">
    ...
    <div class="intro-y box bg-theme-1 p-5 mt-6">
        ...
        <a href="javascript:;" data-toggle="modal" data-target="#superlarge-modal-size-preview" class="button button--lg flex items-center justify-center text-gray-700 dark:text-gray-300 w-full bg-white dark:bg-theme-1 mt-2">
